...
INSERT INTO todos (ref, title, status, track, step, letter, adr, notes) VALUES
  ('wave009-A', 'Wave 009 A — Plan: runner-proof', 'pending', 'wave-009-runner-proof', 1, 'A', '0009', 'Plan in progress: unit-test composePrompt/escalation; stub open-weight + closed runners; optional model/costClass; open-model docs. ADR 0009.'),
  ('wave009-B', 'Wave 009 B — Build: runner-proof', 'pending', 'wave-009-runner-proof', 2, 'B', '0009', 'Implement run tests, cost fields, gitignore .whw/runs/, escalation open-model examples.'),
