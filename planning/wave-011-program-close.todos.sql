...
INSERT INTO todos (ref, title, status, track, step, letter, adr, notes) VALUES
  ('wave011-A', 'Wave 011 A — Plan: program-close', 'pending', 'wave-011-program-close', 1, 'A', '0012', 'Seed planning + branch per letter. PR A: this seed file.'),
  ('wave011-B', 'Wave 011 B — Build: program-close', 'pending', 'wave-011-program-close', 2, 'B', '0012', 'Implement the wave scope. Small PRs only.'),
